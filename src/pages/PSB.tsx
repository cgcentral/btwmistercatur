...
export default function PSB() {
  ...
  const testimonials = [
    {
      name: "Laras",
      text: "Gak nyesel check out buku ini, materinya gampang nempel di kepala. Beneran sesuai judulnya, buku ini bikin kita napas bentar, 'pulang' buat benerin niat, terus lanjut 'berlari' lagi."
    },
    {
      name: "Andiana",
      text: "Rasanya kayak ditampar bolak-balik. selama ini sibuk ngejar karir dan validasi, tapi lupa peran sejati di mata Allah itu apa. Habis baca ini, mindset berangkat kerja langsung beda."
    },
    {
      name: "Ikhsan",
    ...
    {
      name: "Fajar Susilo",
      text: "Sambil baca langsung sadar, iya apa peran saya ya selama ini. Langsung lebih terarah sekarang mencari dan berdoa agar peran untuk saya segera saya dapatkan."
    }
  ];
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-2/3">
              ...
              <p className="text-lg text-gray-400 leading-relaxed mb-6">
                "Buku ini tidak menawarkan rumus instan, tidak menjanjikan hidup tanpa luka, dan tidak menjual optimisme kosong. Yang saya tawarkan hanyalah satu hal: ruang untuk berhenti sejenak, merenung, dan mendengar kembali suara hati yang mungkin lama terabaikan." — <strong>Muhamad Catur Gunandi</strong>
              </p>
              <p className="text-lg text-gray-400 leading-relaxed mb-6">
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Buku ini telah menemani perjalanan banyak pembaca menemukan kembali langkah mereka.</p>
          </div>
